...
//Creacion de la funcion AddNewContact
export default function AddNewContact (props){
    //Utilizamos useContext y useState para proceder a añadir el nuevo contacto
    ...
    //variables con la infor de contacto
    let newContact = {name:"", phone:"", email:"", address:""};

    let counter = 0;

    //comrpobamos contact.info
